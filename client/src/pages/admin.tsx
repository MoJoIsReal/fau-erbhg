...
export default function Admin() {
  ...
  const cards = [
      ...
      ? [
          {
            ...
            valueLabel:
              newMessages.length === 1
                ? language === "no" ? "ny henvendelse" : "new inquiry"
                : language === "no" ? "nye henvendelser" : "new inquiries",
            ...
            detail:
              newMessages.length > 0
                ...
                : language === "no" ? "alt er behandlet" : "all handled",
          },
        ]
      : []),
    {
      ...
      valueLabel:
        publishedPosts.length === 1
          ? language === "no" ? "publisert innlegg" : "published post"
          : language === "no" ? "publiserte innlegg" : "published posts",
      attention: false,
      detail:
        language === "no"
    ...
    },
    {
      ...
      valueLabel:
        language === "no" ? "lastet opp siste 30 dager" : "uploaded in the last 30 days",
      attention: false,
      detail:
        language === "no"
      ...
      ? [
          {
            ...
            value: "",
            valueLabel: language === "no" ? "Styret, barnehagen, brukere" : "Board, kindergarten, users",
            attention: false,
            detail: language === "no" ? "og nyhetsbrev-abonnenter" : "and newsletter subscribers",
          },
        ]
      : []),
  ];
      ...
      <Card className="mt-6">
        <CardContent className="flex flex-wrap items-center justify-between gap-3 p-5">
            ...
            <div>
              <p className="font-medium text-neutral-900 dark:text-neutral-50">
                {nextEvent
                  ...
                  : language === "no" ? "Ingen kommende arrangementer" : "No upcoming events"}
              </p>
                  ...
                  ? `${formatDate(nextEvent.date, language)}${
                      nextEvent.event.noSignup || nextEvent.event.vigiloSignup
                        ...
                        : ` · ${nextEvent.event.currentAttendees || 0} ${
                            language === "no" ? "påmeldte" : "registered"
                          }`
                    }`
                  : language === "no"
          ...
          >
            ...
            {language === "no" ? "Til arrangementer" : "Go to events"}
          </Link>
        </CardContent>
      </Card>
    </div>
